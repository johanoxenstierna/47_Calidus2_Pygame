...
# FRAMES_START = 0
FRAMES_STOP = 15000  #30000  OBS: Will be bugs if lower than, say,  30000 / 60 = 500 seconds
...
SS = 2  # SSAA (super sampling anti aliasing) SET TO 2 FOR HIGHER QUALITY
...
GEN_DL_PIC_BANK = 0#'9_Neptune' #'6_Jupiter' #'4_Moon' #'4_Earth'  #  DEFAULT = 0 OBS PHI==0 WHEN GENERATING. ALSO, WHENEVER CHANGING ANY GI PARAMETERS ACTUALLY
USE_DL = 1
N_ORBIT_SAMPLES = 4096 #2048  # number of coordinates per orbit
N_ORBIT_IMAGES = 32
